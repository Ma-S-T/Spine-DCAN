...
parser.add_argument('--snapshot_path', default=r'result', type=str, help='saved model path')
parser.add_argument('--test_dataset_path', type=str, default=r'dataset(old)/Test', help="testing dataset(old) path")
