...
# %%Training config
parser.add_argument('--net_name', default='SpineDCAN', type=str, help='model')
parser.add_argument('--num_classes', default=12, type=int, help='output channel of network')
parser.add_argument('--max_epochs', default=300, type=int, help='maximum epoch number for training')
parser.add_argument('--batch_size_train', default=3, type=int, help='batch_size for training')
parser.add_argument('--batch_size_eval', default=3, type=int, help='batch_size for validation and test')
