...
if __name__ == "__main__":
    train_dataset = aug_disk_512(r'../dataset/Train/p9', 12, [0, 0], 0, [9, 17, 33], 1)
    train_dataset.set_sigma(0.25)
    ...
    ax[1].imshow(label, cmap=new_cmap, vmin=0, vmax=11, interpolation='nearest')
    plt.show()
